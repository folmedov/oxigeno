...
class Terapia
{
     ...
     * 
     * @ORM\ManyToOne(targetEntity="Oxigeno\Extranet\PacienteBundle\Entity\FichaMedica", cascade={"persist"})
     */
     ...
     * @return \Oxigeno\Extranet\Terapia\HiperbaricaBundle\Entity\Terapia
     */
